...
class AllCallsWidget extends ConsumerStatefulWidget {
  const AllCallsWidget({super.key});

  @override
  ConsumerState<AllCallsWidget> createState() => _AllCallsWidgetState();
}

class _AllCallsWidgetState extends ConsumerState<AllCallsWidget> {
  @override
  Widget build(BuildContext context) {
    final allCallsAsync = ref.watch(allCallHistoryProvider);

    return allCallsAsync.when(
      data: (allCallsData) {
        if (allCallsData.isEmpty) {
          return Center(
            child: Text(
              "No call history yet",
